...
**→ NEXT candidates (from the roadmap below):** RAG chat (explain-only, Phase 5), un-park game-length (HowLongToBeat/IGDB), or the submission-polish phase (writeup → Word/PDF, perf, cleanup).
